	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		...
		<?php if(AuthComponent::user('id')){?>
			<ul class="nav navbar-nav side-nav">
				...
				<li class="dropdown <?php echo $this->params->params['controller'] == 'users' ? 'active' : ''?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-users"></i> Database List <b
							class="caret"></b></a>
					<ul class="dropdown-menu">
						<?php
						$i=0;
            ...
            $data = $db->fetchall("show  databases"); 
						foreach ($data as $value) {
							...
							?>
						<li><a href="<?php echo $this->params->webroot?>users/showtable/<?php echo $param ?>"><i class="fa fa-list"></i><?php echo $value["SCHEMATA"]["Database"];?></a></li>
					<?php	
					$i++;
					}
						?>
