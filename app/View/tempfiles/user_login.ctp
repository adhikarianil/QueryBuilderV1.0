   ...
   <div class="jumbotron">
        <div id="logo">  <?php $this->Html->image('/cake_querybuilder/webroot/img/logo.png'); ?></div>
    </div>
    <div id= "navbar">sdf</div>
    <div id="container">
    <div style="position: relative; margin-top:5px; margin: 50 auto; padding: 18px 18px 18px; width: 400px; background: white; border-radius: 4px; -webkit-box-shadow: 0 0 200px rgba(255, 255, 255, 0.5), 0 1px 2px rgba(0, 0, 0, 0.3);
